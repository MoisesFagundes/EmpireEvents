(function ($) {
	...
	/*Esqueceu a senha*/
    $('#login-button1').on('click', function (e) {
        e.preventDefault();
        var self = $(this),
            target = self.next('#login-form1');
        if (self.hasClass('open')) {
            target.slideUp('slow');
            self.removeClass('open');
        } else {
    ...
    $('#login-form1').on('click', '.form-cancel', function (e) {
        e.preventDefault();
        var self = $(this),
            parent = self.parents('#login-form1'),
            loginButton = parent.prev('#login-button1');
        parent.slideUp('slow');
        loginButton.removeClass('open');
        return false;
    });
